...
export default new Vuex.Store({
  ...
  state: {
    ...
    apiUrl: "https://hqp-be.onrender.com",
  },
  getters: {},
  actions: {
    ...
    login: function (context, data) {
      return new Promise((resolve, reject) => {
        axios
          .post(`${context.state.apiUrl}/api/auth/login`, data)
          .then((res) => {
            resolve(res);
          })
    ...
    logout: function (context) {
      axios
        .delete(
          `${context.state.apiUrl}/api/auth/logout`,
          context.state.headerconfig
        )
        .then(() => {
    ...
    refreshtoken: function (context) {
      ...
      axios
        .post(`${context.state.apiUrl}/api/auth/refreshtoken`, {
